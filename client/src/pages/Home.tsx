...
const QR_TYPES = [
  ...
  { id: "website", label: "الموقع الإلكتروني", icon: Globe, description: "ربط URL لموقع الويب" },
  { id: "facebook", label: "Facebook", icon: Facebook, description: "مشاركة صفحات الفيسبوك" },
  ...
  { id: "social", label: "وسائل التواصل الاجتماعي", icon: Users, description: "مشاركة قنوات التواصل الاجتماعية" },
  { id: "instagram", label: "Instagram", icon: Instagram, description: "مشاركة حسابك الخاص بك" },
