...
## تطوير متقدم لإدارة المستخدمين والنقاط
- [ ] تطوير خيارات التعديل المتقدمة للمستخدمين
- [ ] إضافة إجراءات tRPC للتعديل المتقدم
- [ ] بناء نموذج التعديل المتقدم مع تبويبات
- [ ] تطوير مزايا إدارة النقاط الكاملة
- [ ] إضافة إجراءات tRPC لإدارة معدلات النقاط والمكافآت
- [ ] بناء نماذج إدارة المعدلات والمكافآت
- [ ] عرض إحصائيات حقيقية للنقاط
- [ ] تفعيل جميع خيارات التعديل اليدوي للنقاط


## إضافة التنبيهات والرسائل (Toast Notifications)
- [x] تثبيت مكتبة sonner للتنبيهات
- [x] إضافة Toaster إلى main.tsx
- [x] إضافة تنبيهات نجاح عند تحديث معدلات النقاط
- [x] إضافة تنبيهات معلومات عند تفعيل/تعطيل المعدلات
- [x] إضافة تنبيهات نجاح عند تعديل نقاط المستخدمين
- [x] إضافة تنبيهات معلومات عند فتح نماذج التعديل والإضافة
- [x] إضافة تنبيهات خطأ عند حذف المكافآت
- [x] كتابة واختبار اختبارات vitest للتنبيهات
